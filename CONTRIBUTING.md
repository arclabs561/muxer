# Contributing to muxer

Thanks for your interest. muxer is deterministic, multi-objective bandit-style routing primitives (windowed stats + Pareto selection).
...
- Rust toolchain: stable, MSRV `1.66`. Use `rustup` to manage.
...
- Commit messages: `muxer: short lowercase description`. One commit per logical change.
